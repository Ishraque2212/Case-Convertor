...
export default function About() {
    ...
    const toogleMode = () => {
        console.log("Toogle mode clicked");
    ...
    return (
        <div className='container my-3' style={myStyle}>
            <h1 className='container my-3'>Accordion</h1>
            ...
            <button type="button" className="btn btn-dark my-3" style={btnColor} onClick={toogleMode}>{btnText}</button>
        </div>
    )
}
